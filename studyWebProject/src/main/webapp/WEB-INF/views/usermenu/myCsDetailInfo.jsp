...
<section>
	...
	<div class="d-flex" style="margin-left:20%; margin-top:40px;">
		<p>문의번호 : ${csDTO.cs_serial}</p>
		<p style="margin-left:80px">문의유형 : ${csDTO.cs_code}</p>
		<p style="margin-left:80px">제목 : ${csDTO.cs_title}</p>
		<p style="margin-left:80px">등록일자 : ${csDTO.cs_dt}</p>
		<p style="margin-left:80px">처리상태 : ${csDTO.proc_sts}</p>
	</div>
